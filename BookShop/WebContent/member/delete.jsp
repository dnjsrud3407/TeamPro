...
<!-- Sidebar end=============================================== -->
	...
	<form class="form-horizontal" action="DeletePro.me" method="post">
...
<!-- 		</select> -->
		 ...
		 <div class="control-group">
			...
			<div class="controls">
			  <input type="password" id="inputPassword"  name="pw" required="required" style="position: relative; top: -18px; left: 90px"><button onClick="javascript:deleteuser()" type="submit" id="submitButton" class="btn btn-primary" style="margin:20px; position: relative; top: -18px; left: 90px">확인</button>

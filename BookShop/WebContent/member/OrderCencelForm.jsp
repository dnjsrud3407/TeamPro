...
<body>
<h3 style="background-color: black;"><a style="color: white;">취소 신청</a></h3>
	...
	<table class="table">
        ...
        <thead>
          <tr>
            <th class="control-label" style="background-color: #f5f5f5;">취소 사유</th>
            <td>
              <select id="select01">
          ...
          <tr>
           <td style="background-color: #f5f5f5;">취소 상세 사유 </td>
           <td>

...
<!-- ---------------------------------------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">취소완료내역</h1>
          <p class="mb-4">취소완료내역완료목록입니다</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">취소 목룍</h6>
...
<%-- 										<%if(orderDetail.getOrderStatus().equals("주문완료")) {%> --%>
											...
											<tbody>
												<tr onclick="location.href='OrderCencleDetail.adm?orderNum=<%=orderList.get(i).getOrderNum()%>&type=<%=orderList.get(i).getOrderStatus()%>'">

...
function openWin3(orderNum){  
    ...
    window.open("OrderDelivery.mo?orderNum="+orderNum, "배송", "width=500, height=650, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
}  
...
<!--ㅡㅡ--------------ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ------------------------------------------------------    -->
            ...
            <td style="border-bottom: none;" colspan="2"><c:if test="${list.orderStatus eq '배송완료'}"><div class="btn2" ><a href="OrderConFirmPro.mo?orderNum=${list.orderNum}" >구매확정</a></div></c:if></td>
                  ...
                  <td><img width="80px" height="100px" src="upload/${list.bookOriginImage}" alt=""/></td>

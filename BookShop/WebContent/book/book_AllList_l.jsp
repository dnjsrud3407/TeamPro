...
<div id="myTab" class="pull-right">
 <a href="BookListALL.book?type=L&page=${pageInfo.page }"><span class="btn btn-large btn-primary"><i class="icon-list"></i></span></a>
 <a href="BookListALL.book?type=I&page=${pageInfo.page }"><span class="btn btn-large"><i class="icon-th-large"></i></span></a>
</div>
<br><br>
<br class="clr"/>
<div class="tab-content">
	  ...
	  <c:forEach var="book" items="${bookAllList}" varStatus="status">
		...
		<div class="row">	  
			...
			<form class="form-horizontal qtyFrm">
			    ...
			    <a href="CartAdd.book?bookID=${book.bookID }" class="btn btn-large btn-primary"><i class=" icon-shopping-cart"></i></a>
	...
	<ul>
		<c:if test="${pageInfo.startPage > pageInfo.pageBlock }">
			<li>
				<a href="BookListALL.book?type=L&page=${pageInfo.startPage-pageInfo.pageBlock}">&lsaquo;</a>
			</li>
		</c:if>
		<li>
			<c:forEach var="i" begin="${pageInfo.startPage }" end="${pageInfo.endPage }" step="1">
				<c:choose>
                	...
                	<c:otherwise><a href="BookListALL.book?type=L&page=${i}" class="colorB" style="color: #2a84b6; border-color: #5e9bd1;">${i}</a></c:otherwise>
				</c:choose>
			</c:forEach>
		</li>
		<c:if test="${pageInfo.endPage < pageInfo.maxPage }">
			<li>
				<a href='<c:url value="BookListALL.book?type=L&page=${pageInfo.startPage + pageInfo.pageBlock}"/>'>&rsaquo;</a>
			</li>
		</c:if>
	</ul>
	</div>

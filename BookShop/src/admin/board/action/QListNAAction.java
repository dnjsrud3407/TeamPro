...
public class QListNAAction implements Action {
...
//		 BoardListService 객체의 getArticleList() 메서드를 호출 하여 게시물 목록 가져오기
		...
		ArrayList<BoardBean> articleList = boardService.getArticleNAList(pageInfo);
		// 가져온 게시물 목록 리퀘스트에 저장
		...
		// 이벤트로 고칠것
		forward.setPath("./admin/board/qListNA.jsp");
